...
export default function UploadModal({ isOpen, onClose, patient }) {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const response = await uploadNii({ formData, patient_id: patient?.id }).unwrap();
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <Card className="max-w-md w-full">
                ...
                <CardContent className="space-y-6">
                    <div
                        className={`border-2 border-dashed rounded-lg p-6 text-center transition-colors ${selectedFile ? 'border-red-600 bg-red-50' : 'border-gray-300 hover:border-red-400'
                            }`}
                    ...
                    >
                        {selectedFile ? (
                            <div className="space-y-2">
                                ...
                                <p className="text-sm font-medium text-red-600">File Selected</p>
